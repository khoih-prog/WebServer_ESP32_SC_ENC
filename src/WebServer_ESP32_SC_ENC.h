...
//////////////////////////////////////////////////////////////
  ...
  #define WEBSERVER_ESP32_SC_ENC_VERSION       "WebServer_ESP32_SC_ENC v1.2.0 for core v2.0.0+"
#else
  #if (_ETHERNET_WEBSERVER_LOGLEVEL_ > 2)
    #warning Using code for ESP32 core v1.0.6- in WebServer_ESP32_SC_ENC.h
  #endif

  #define WEBSERVER_ESP32_SC_ENC_VERSION       "WebServer_ESP32_SC_ENC v1.2.0 for core v1.0.6-"
#endif
...
#define WEBSERVER_ESP32_SC_ENC_VERSION_INT      1002000
